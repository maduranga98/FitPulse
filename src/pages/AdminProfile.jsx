      ...
      <div className="p-4 sm:p-6">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            {/* Avatar banner — full width */}
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 flex items-center gap-5">
              <div className="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center text-white text-3xl font-bold flex-shrink-0">
              ...
              <div>
                ...
                <div className="text-blue-200 text-sm capitalize mt-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Account info — takes 2/3 width */}
              <div className="lg:col-span-2 bg-gray-800 border border-gray-700 rounded-xl p-4 sm:p-6">
              ...
              {/* Right column — gym details + password notice */}
              <div className="space-y-6">
