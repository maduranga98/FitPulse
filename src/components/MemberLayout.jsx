        ...
        <header className="lg:hidden bg-gray-800 border-b border-gray-700 px-4 py-3 flex items-center justify-between relative">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="w-8 h-8 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center active:scale-95 transition"
            >
          ...
          {showMobileMenu && (
            <>
              ...
              {/* Menu */}
              <div className="absolute top-full right-4 mt-2 w-64 bg-gray-800 border border-gray-700 rounded-xl shadow-xl z-50 overflow-hidden">
                {/* User Info */}
                ...
                <div className="p-2">
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2 text-gray-300 hover:bg-gray-700 rounded-lg transition text-sm"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
                ...
                <div className="p-2 border-t border-gray-700">
                  <button
                    onClick={handleLogoutClick}
                    className="w-full flex items-center gap-3 px-3 py-2 text-red-400 hover:bg-red-600/10 rounded-lg transition text-sm font-medium"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
